...
subtitle: "Compulsión a la repetición: por qué insistimos con el mismo número"
...
Y eso que pasa, ¿qué es? No es el premio que no llegó. Lo que se repite es **la escena**: el papelito en el bolsillo, el camino a la agencia, ese minuto exacto entre apostar y saber el resultado, cuando Roberto es todavía alguien que podría. Lo que vuelve no es ganar. Es ese minuto. El premio, cuando llega, interrumpe. No completa.

Y la última pieza, la más freudiana de todas: **donde no se recuerda, se repite**. Lo que no podemos poner en palabras vuelve actuándose. Cada número que vuelve, en cada uno, vuelve por algo. **El síntoma puede leerse.** Leerlo no termina con el juego: descongela al jugador.
